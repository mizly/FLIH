...
class MobileNetAgent(nn.Module):
    """
    Agent that uses MobileNetV3-Large to process visual observations and a GRU for memory.
    Input: Stereo camera images (stacked horizontally) + Goal Direction + Collision.
